        ...
        stage('Deploy (docker-compose') {
            steps {
                ...
                sshagent (credentials: ['two']) {
                    sh 'ssh -o StrictHostKeyChecking=no ubuntu@ec2-18-234-79-198.compute-1.amazonaws.com "cd app;  sudo docker-compose down; sudo docker-compose up --force-recreate --detach"'
                }
            }
        }
    }
