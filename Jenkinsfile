    ...
    stages {
        ...
        stage('Deploy (docker-compose') {
            steps {
                ...
                sh("sudo ssh -i /home/ec2-user/.ssh/two.pem -tt ubuntu@ec2-52-87-235-195.compute-1.amazonaws.com 'cd app && sudo docker-compose down && sudo docker-compose up --detach'")
            }
        }
    }
}